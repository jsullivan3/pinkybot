...
replies = [
   ...
   # Pinky: "Yes, I am!"
   # Brain: "This is fantastic! Do you see?! You've already saved us an entire evening!Tremendous! Forger that plan. Take a look at this one... colleague."
   ...
   "Well, I think so, Brain... (holds up a leg) ...but it's a miracle that this one grew back.",
   ...
   "I think so, Brain, and um, Larry, but how can we get 7 dwarves to shave their legs?",
   ...
   "Um, I think so, Big Brainy Fish Face Stovepipe Wiggle Room Eileen, but if you get a long, little doggie, wouldn't you just call it a dachshund?",
   ...
   "Why, yes! Yes, I am! But where would you get a chicken, 20 yards of spandex and smelling salts at this hour?",
   ...
   "Well, I think so, Brain, but my feet taste better buttered.",
